...
?>
  <tr>
    ...
    <td style="text-align:center;"><?php echo '<a href="delete1.php?id='.$Result['ID'].'" class="btn btn-info">Delete</a>'?>
        <?php echo '<a href="edit1.php?id='.$Result['ID'].'" class="btn btn-info">Edit</a>'?></td>
  </tr>
<?php
}
?>
